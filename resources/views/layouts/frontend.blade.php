                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/rifki.png') }}" alt="">
                                </a>
                            </div>
                            <div class="menu-style-2 furniture-menu menu-hover">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('shop.index') }}">Umkm</a>
                                        </li>
                                        <li>
                                            
                                            <a href="{{ route('wilaya.index') }}">Wisata</a>
                                        </li>
                                    ...
                                    @foreach (\Cart::getContent() as $item)
                                     ...
                                     @endforeach
                                        ...
                                        <li class="cart-btn-wrapper">
                                            ...
                                            <a class="cart-btn btn-hover" href="https://wa.me/+6281313282130?text=Saya%20tertarik%20dengan%20aksesoris%20yang%20Anda%20jual">checkout</a>
                                        </li>
                                    </ul>
                                 @endif   
                            </div>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/rifki.PNG') }}" alt="">
                            <div class="footer-about-2">
                                <p>Sehingga pengembangan UMKM tidak luput dari kontribusi pembiayaan<br>perbankan dan lembaga keuangan lainnya yang masih  <br>  keterbatasan informasi</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>62 Bandung Jawa Barat <br>IN- +62</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> Rifki@gmail.com</a> <br><a href="#"> UMKM@mail.info</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://hastech.company/">Rifki KP</a> 2022 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
        ...
        <script>
            ...
            // pencarian beruntun
            // metode search algoritma squential search .menggunakan javascript
